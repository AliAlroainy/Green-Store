      ...
      <div id="carouselExampleControls" class="carousel slide " data-ride="carousel">
        <div class="carousel-inner">
          <div class="carousel-item active">
            <div class="img-box">
              <img height="500" src="images/bg.jpg" alt="">
            </div>
          </div>
          <div class="carousel-item">
            <div class="img-box">
              <img height="500" src="images/bg1.jpg" alt="">
            </div>
          </div>
          <div class="carousel-item">
            <div class="img-box">
              <img height="500" src="images/bg2.jpg" alt="">
            </div>
          </div>
        </div>
  ...
  <section class="shop_section layout_padding">
    <div class="container">
      <div class="box">
        ...
        <div class="img-box">
          <img src="images/tot-removebg-preview.png" alt="">
        </div>
        <div class="btn-box">
          <a href="checkout.php">
            Buy Now
